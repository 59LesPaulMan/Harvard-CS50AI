...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        # Unconditional gene probability
        if mother is None and father is None:
            gene_prob = PROBS["gene"][genes]
        else:
            mom_pass = passed_gene(mother)
            dad_pass = passed_gene(father)
...
def update(probabilities, one_gene, two_genes, have_trait, p):
    ...
    # Genes need to be numeric of 2, 1, or None (0)
    for person in probabilities:
        ...
        trait = (
            person in have_trait
        )  # sets up a variable for trait in the have_trait argument
...
def normalize(probabilities):
    ...
    """
    # for each person in probablities - normalize gene distro
    for person in probabilities:
        ...
        # for each person nomralize trait distro
